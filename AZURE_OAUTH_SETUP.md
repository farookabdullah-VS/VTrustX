# How to Register an Application in Azure Portal for RayiX OAuth

Follow these steps to configure "Log in with Microsoft" for your RayiX application.
...
5.  **Name**: Enter `RayiX` (or your preferred app name).
...
7.  **Redirect URI**:
    ...
    *   Enter your Production URI:  
        `https://rayix-service-142641550878.us-central1.run.app/api/auth/microsoft/callback`
...
4.  **Description**: Enter `RayiX Server Key`.
...
1.  Go to Cloud Run -> `rayix-service` -> **Edit & Deploy New Revision**.
...
**Using Command Line:**
```powershell
gcloud run services update rayix-service --region us-central1 --set-env-vars MICROSOFT_CLIENT_ID="<YOUR_ID>",MICROSOFT_CLIENT_SECRET="<YOUR_SECRET>"
```

### 5. Verification
1.  Wait for the deployment to finish.
2.  Visit your RayiX login page.
